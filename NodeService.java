...
public class NodeService {  
    ...
    // Call CreateNode to create Node
    ...
    // Call Query Result to get employee list for given employee name
    public String QueryResult	(@QueryParam("emp_name") String emp_name, @QueryParam("neo4jServer") String neo4jServer
    		, @QueryParam("neo4jUsr") String neo4jUsr, @QueryParam("neo4jPwd") String neo4jPwd)
   {
